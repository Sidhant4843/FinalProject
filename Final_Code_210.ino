...
const char topic1[] = "gagan";
const char topic2[] = "DHT";
const char *HOST="api.thingspeak.com";
String api_key = "5RVAHHGSQ7GITT72";
...
void loop() {
  ...
  if (isnan(temperature) || isnan(waterLevel)) {
  ...
  Send_Data(temperature,waterLevel);
  delay(1000);
}

void Send_Data(float t, int waterlevel) {
...
//       Serial.println("Published WaterLevel: " + String(waterLevel));
//       client.endMessage();
...
//     delay(2000);  // Publish every 2 seconds (adjust as needed)
//   }
// }